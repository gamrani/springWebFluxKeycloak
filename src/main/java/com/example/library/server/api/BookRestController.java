...
import com.example.library.server.security.LibraryUserDetails;
...
public class BookRestController {
  ...
  public Mono<Void> borrowBookById(@PathVariable(PATH_VARIABLE_BOOK_ID) UUID bookId, @AuthenticationPrincipal LibraryUserDetails libraryUserDetails) {
    return bookService.borrowById(bookId, libraryUserDetails !=null ? libraryUserDetails.getId() : null);
  }

  @PostMapping("/books/" + PATH_BOOK_ID + "/return")
  public Mono<Void> returnBookById(@PathVariable(PATH_VARIABLE_BOOK_ID) UUID bookId, @AuthenticationPrincipal LibraryUserDetails libraryUserDetails) {
    return bookService.returnById(bookId, libraryUserDetails != null ? libraryUserDetails.getId() : null);
  }
